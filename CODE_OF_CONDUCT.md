...
Deutsch: Dieses Repository nimmt den Contributor Covenant in Version 2.1 an. Der
Grund ist die Zweisprachigkeit. Dieser Kodex liegt in einer offiziellen deutschen
Übersetzung vor, sodass beide Sprachen denselben Text meinen und nicht zwei
Fassungen entstehen, die auseinanderlaufen. Er ist außerdem der Text, den die
meisten Beitragenden schon kennen, was einem Repository für Anfänger mehr nützt
als ein selbst geschriebener.

Der deutsche Abschnitt unten ist die offizielle Übersetzung, der englische der
Originaltext. Beide sind wörtlich übernommen, mit zwei Eingriffen: die
Meldestelle ist eingesetzt, und alle Überschriftenebenen sind um eine Stufe
verschoben, damit die Datei eine einzige oberste Überschrift hat. Am Wortlaut
ändert das nichts.

Eine eigene Meldeadresse gibt es nicht. Meldungen laufen über das Meldeformular
von GitHub und erreichen damit zuerst GitHub und nicht das Projekt. Das ist ein
schwacher Weg, und er steht hier, statt weggelassen zu werden.

English: this repository adopts the Contributor Covenant in version 2.1. The
reason is the bilingual rule. This code exists in an official German
translation, so both languages mean the same text instead of two versions that
drift apart. It is also the text most contributors already know, which helps a
repository for beginners more than one written from scratch.

The German section below is the official translation, the English one the
original. Both are taken verbatim, with two interventions: the reporting route
is filled in, and every heading level is shifted down by one so that the file has
a single top heading. Neither changes the wording.

There is no reporting address of its own. Reports go through GitHub's abuse
form and therefore reach GitHub before they reach the project. That is a weak
route, and it stands here rather than being left out.

Der Contributor Covenant steht unter CC BY 4.0. / The Contributor Covenant is
licensed under CC BY 4.0. https://www.contributor-covenant.org
...
Fälle von missbräuchlichem, belästigendem oder anderweitig inakzeptablem Verhalten können unter dem Formular unter https://github.com/contact/report-abuse, unter Nennung dieses Repositories der für die Durchsetzung zuständigen Gemeinschaftsleitung gemeldet werden. Alle Beschwerden werden zeitnah und fair geprüft und ermittelt.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at the form at https://github.com/contact/report-abuse, naming this repository. All complaints will be reviewed and investigated promptly and fairly.
